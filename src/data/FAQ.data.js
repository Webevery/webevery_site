export const FAQdata = [
  {
    ...
    answer:
      'Наш досвід дозволяє проконсультувати та розрахувати бюджет і терміни саме під ваші потреби, враховуючи всі можливі ризики. Для цього зв’яжіться з нами та поділіться своїми ідеями. Більш детальну інформацію ви можете дізнатись у розділі "Послуги"',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    answer:
      'Зазвичай ми працюємо віддалено і маємо для цього налаштовані всі необхідні процеси. Також можливий виїзд наших спеціалістів до Вас в офіс. Місцезнаходження наших спеціалістів ви можете подивитись у розділі "Команда".',
  },
  {
    id: 13,
