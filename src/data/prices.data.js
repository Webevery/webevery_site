...
export const pricesData = [
  {
    ...
    title: 'Сайт-візитка',
    description:
      'Простий веб-ресурс, розрахований на 3-5 сторінок і містить: основну інформацію про організацію, приватну особу; послуги; фотогалерею та контактні дані. Сайт-візитка відмінно підійде невеликій компанії, фрілансерам, художникам, приватним икладачам та всім, хто бажає запропонувати низку своїх послуг в інтернеті.',
    image: visitSite,
    price: '350',
    daysCount: '7-10 ',
    details: [
