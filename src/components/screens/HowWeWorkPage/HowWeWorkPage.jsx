          ...
          <ul className={styles.list}>
            ...
            <li className={styles.listItem}>
              <div className={styles.container2}>
                ...
                <p className={styles.listItemText}>
                  Ми використовуємо новітні технології для створення
                  привабливих, зручних і загальноприйнятих веб-сайтів. Ми
                  створюємо конкурентоспроможні веб-сайти для будь-якої
                  категорії бізнесу.
                </p>
              </div>
            </li>
            ...
            <li className={styles.listItem}>
              <div className={styles.container2}>
                ...
                <p className={styles.listItemText}>
                  ...
                  функціонального тестування, перевірки працездатності продукту
                  під навантаженням і профілювання основних модулів. Цей процес
                  має вирішальне значення, орієнтований на деталі та важливий
                  для забезпечення успіху всього тестування.
                </p>
              </div>
            </li>
            <li className={styles.listItem}>
